...
const currencyPaymentMethodConfig: Record<CurrencyEnum, PaymentMethodEnum[]> = {
  ...
  [CurrencyEnum.SEK]: [PaymentMethodEnum.CARD, PaymentMethodEnum.IBAN],
  [CurrencyEnum.MDL]: [PaymentMethodEnum.CARD],
  [CurrencyEnum.AMD]: [PaymentMethodEnum.CARD, PaymentMethodEnum.AMD_IDRAM],
  [CurrencyEnum.KGS]: [PaymentMethodEnum.CARD, PaymentMethodEnum.KGS_ELCART],
  [CurrencyEnum.BGN]: [PaymentMethodEnum.CARD, PaymentMethodEnum.IBAN],
  [CurrencyEnum.HUF]: [PaymentMethodEnum.CARD],
  [CurrencyEnum.GEL]: [PaymentMethodEnum.CARD, PaymentMethodEnum.IBAN],
  ...
  [CurrencyEnum.IDR]: [PaymentMethodEnum.CARD, PaymentMethodEnum.IBAN],
  [CurrencyEnum.RON]: [PaymentMethodEnum.CARD, PaymentMethodEnum.IBAN],
  [CurrencyEnum.BRL]: [
    PaymentMethodEnum.CARD,
  ...
  [CurrencyEnum.VND]: [PaymentMethodEnum.CARD, PaymentMethodEnum.IBAN],
};
