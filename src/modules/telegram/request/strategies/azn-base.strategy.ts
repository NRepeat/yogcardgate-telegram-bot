...
export interface AznStrategyDependencies {
  ratesService: RatesService;
  requestService: RequestService;
  vendorService: VendorService;
}

export abstract class AznBaseStrategy implements PaymentRequestStrategy {
  protected readonly targetCurrency = CurrencyEnum.AZN;

  constructor(protected readonly deps: AznStrategyDependencies) {}
  ...
  async execute(
    ...
    try {
      ...
      console.error('[AZN Strategy] Unexpected error:', error);
      return {
        status: 'error',
