...
export interface CzkStrategyDependencies {
  ratesService: RatesService;
  requestService: RequestService;
  vendorService: VendorService;
}

export abstract class CzkBaseStrategy implements PaymentRequestStrategy {
  protected readonly targetCurrency = CurrencyEnum.CZK;

  constructor(protected readonly deps: CzkStrategyDependencies) {}
  ...
  async execute(
    ...
    try {
      ...
      console.error('[CZK Strategy] Unexpected error:', error);
      return {
        status: 'error',
