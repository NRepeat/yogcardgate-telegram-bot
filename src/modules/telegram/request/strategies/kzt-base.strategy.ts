...
export interface KztStrategyDependencies {
  ratesService: RatesService;
  requestService: RequestService;
  vendorService: VendorService;
}

export abstract class KztBaseStrategy implements PaymentRequestStrategy {
  protected readonly targetCurrency = CurrencyEnum.KZT;

  constructor(protected readonly deps: KztStrategyDependencies) {}
  ...
  async execute(
    ...
    try {
      ...
      console.error('[KZT Strategy] Unexpected error:', error);
      return {
        status: 'error',
