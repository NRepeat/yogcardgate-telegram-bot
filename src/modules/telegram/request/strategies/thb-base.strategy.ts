...
export interface ThbStrategyDependencies {
  ratesService: RatesService;
  requestService: RequestService;
  vendorService: VendorService;
}

export abstract class ThbBaseStrategy implements PaymentRequestStrategy {
  protected readonly targetCurrency = CurrencyEnum.THB;

  constructor(protected readonly deps: ThbStrategyDependencies) {}
  ...
  async execute(
    ...
    try {
      ...
      console.error('[THB Strategy] Unexpected error:', error);
      return {
        status: 'error',
